class RegistrationsController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:nickname,:email,:password,:password_confirmation,:last_name,:first_name,:last_name_kana,:first_name_kana,:birth_day,:birth_month,:birth_year,:tel,address_attributes: [:post_address,:prefecture,:city,:house_number,:building_name,:tel])
    end
